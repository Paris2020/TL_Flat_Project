											...
											"<div id= 'sideBar'>",
												...
												echo "<h2>Welcome to - The Lady</h2>",
													 "<p><b><i>The Lady</i></b> is is a blog, my own personal journal online.",
														...
														"This will become your second home. Explore all the luxuries in this website. Check out my <a href='profile.html'>profile</a> ",
														"and find out more about me - Oh by the way my name is <b><i>Nelly Moseki</i></b> (assuming you weren't aware by now).</p>";
														
												echo "<p>Want to know what I've been up to in the past 4 years, why hesitate, click my <a href='accomplishments.html'>accomplishments</a> to witness what ",
														"I have achieved thus far and to view what I've been working on lately, click on <a href='projects.html'>projects<a/> ",
														"to see what I've been engrossed in.</p>";

												echo "<p id='bella'><a id='leftArrow' href='previous.html' onmouseover=”document.myPicture.src=’images/arrow_left.jpg’;”
														onmouseout=”document.myPicture.src=’images/plain_sheet.jpg’” ><img class='arrows' width='50' height='100' id='prevImg'
													   alt='Previous'/></a><img class='signorina' id='myPicture' src='images/bella_11.jpg' width='200' height='270'  alt='Picture of me here'
													   /><a id='rightArrow' href='next.html' onmouseover=”document.myPicture.src=’images/arrow_right.jpg’;”
														onmouseout=”document.myPicture.src=’images/plain_sheet.jpg’”><img class='arrows' width='50' height='100' id='nextImg'
													   alt='Next'/></a></p>";
												...
												echo "	<p>
														...
														on my <a href='tutorials.html'>tutorials</a> page.
														</p>";
												...
												echo "	<p>
														...
														<b>IT'S ONLY WISE TO ALWAYS BE ON YOUR TOES </b> <img src='images/footprint.jpg' width='20' height='20' alt='Toes here'
														/><img src='images/footprint.jpg' width='20' height='20' alt='Toes here'/>.</p>";
