...
<?php					
							...
							echo "<script type='text/javascript'>",
								...
								"</script>";					
							echo "</div></td></tr>";
							echo "<tr><td><img src='images/tutorials_banner.jpg' width='860' height='70' alt='Welcome to The Lady'/></td></tr>";
							?><tr><td id="MainMenu">
										<div>
											...
											/></a><a href="#" onclick="overlay()" onmouseover="rollover2('tutorials','images/tutorials.jpg')" onmouseout="rollover2('tutorials','images/tutorials_curr.jpg')"><img src="images/tutorials_curr.jpg" id="tutorials" width="110" height="40" alt="TUTORIALS"
										...
										"<tr><td id='ContentLeft'>",
											"<div id= 'sideBar'>",
												...
												"<p>
													...
													"<a href='tutorials.php?content=sql'>SQL Server</a></p>",
											"</div></td>";		
