		...
		<?php
							...
							echo "<h2>Bio Page</h2>",
									...
									we moved to Gauteng,in Soweto. I'm 22 years old (so I've been living in Dobsonville for almost 2 decades). I went to pre-school at 
									...
									<a href='www.googlemaps.com'><b><i>IIE Rosebank College (Braamfontein) </i></b></a>, where I obtained my Diploma in I.T Software Development and graduated overall top student nationally for all IIE Rosebank College institutions.</p>";
						...
						/*- A diff IFrame and image of selected book to be reviewed
							...
							if(isset($_GET['content'])){
								...
								?><p id="bella"><a id="leftArrow" href="previous.html" onmouseover="rollover3('prevImg','images/arrow_left.jpg')" onmouseout="rollover3('prevImg','images/plain_sheet.jpg')" >
																...
																<a id="" href=""><img id="myPicture" class="signorina"  src="images/bella_11.jpg" width="200" height="270"  alt="Picture of me here"/></a>
																<script>
																	<!--
																	var step = 1;
																	function slideit(){
