							...
							if(isset($_GET['content'])){
								switch($_GET['content']){
									...
									case 'first':
										...
										echo "<p id='firstFrame'><iframe src='Reviews/The_Grave_Robbers_Apprentice.html' width='550' height='250'></iframe></p>";
										echo "<p><form name='frmComment' action='bookReview.php' method='post'>",
											"<fieldset id='field1' >",
											"<p><b>Comment:</b><br></p>",
											"<p><textarea name='comment' id='comment' cols='50' rows='5' maxlength='500'></textarea><br>(Maximum of 500 characters)&nbsp;&nbsp;<a href='countLikes.php' class='likes'><img src='images/like.jpg' width='25' height='25' /><a/></p>",
											"<p><input type='submit' name='submitComm' id='submitComm' value='Submit'/></p></fieldset>",
											"</form></p><hr>"; 
										break;
									case 'second':
										...
										echo "<p id='secondFrame'><iframe src='Reviews/The_Curse_of_the_Dream_Witch.html' width='550' height='250'></iframe></p>";
										echo "<p><form name='frmComment' action='bookReview.php' method='post'>",
											"<fieldset id='field1' >",
											"<p><b>Comment:</b><br></p>",
											"<p><textarea name='comment' id='comment' cols='50' rows='5' maxlength='500'></textarea><br>(Maximum of 500 characters)&nbsp;&nbsp;<a href='countLikes.php' class='likes'><img src='images/like.jpg' width='25' height='25' /><a/></p>",
									...
									case 'third':
										...
										echo "<p id='thirdFrame'><iframe src='Reviews/Leslies_Journal.html' width='550' height='250'></iframe></p>";
										echo "<p><form name='frmComment' action='bookReview.php' method='post'>",
											"<fieldset id='field1' >",
											"<p><b>Comment:</b><br></p>",
											"<p><textarea name='comment' id='comment' cols='50' rows='5' maxlength='500'></textarea><br>(Maximum of 500 characters)&nbsp;&nbsp;<a href='countLikes.php' class='likes'><img src='images/like.jpg' width='25' height='25' /><a/></p>",
									...
									case 'fourth':
										...
										echo "<p id='fourthFrame'><iframe src='Reviews/Borderline.html' width='550' height='250'></iframe></p>";
										echo "<p><form name='frmComment' action='bookReview.php' method='post'>",
											"<fieldset id='field1' >",
											"<p><b>Comment:</b><br></p>",
											"<p><textarea name='comment' id='comment' cols='50' rows='5' maxlength='500'></textarea><br>(Maximum of 500 characters)&nbsp;&nbsp;<a href='countLikes.php' class='likes'><img src='images/like.jpg' width='25' height='25' /><a/></p>",
