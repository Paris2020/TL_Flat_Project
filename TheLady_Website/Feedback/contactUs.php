			...
			<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://wwww.w3.org/TR/xhtml1-strict.dtd">
				...
				<?php echo "<table id='outerTable'>",
							...
							echo "<script type='text/javascript'>",
								...
								"</script>";					
							echo "</div></td></tr>";
							echo "<tr><td><img src='images/contacts_banner.jpg' width='860' height='70' alt='Contact Us Now'/></td></tr>";
							?><tr><td id="MainMenu">
										<div>
							...
							echo "<tr><td>",
									"<table id='MainContentTable'>",
										"<tr><td id='ContentLeft'>",
											...
											"<p><img src='images/homeIcon.jpg' width='15' height='20' alt='Address'/> 11084 Dobsonville ext 2, Mafu Street,1863</p>",
											"<p><img src='images/phone.jpg' width='15' height='20' alt='Phone'/></p>",
											"<p><img src='images/email.jpg' width='15' height='20' alt='email'/></p>",
											"<div></td>";
							...
							"<fieldset id='field1' >",
									...
									"<p>Firstname: <input type='text' name='fName' id='fName' /></p>",
									"<p>Lastname: <input input type='text' name='sName' id='sName' /></p>",
									"<p>Email: <input input type='text' name='email' id='email' /></p>",
									"<p>Phone: <input input type='text' name='email' id='email' /></p>",
									"<p>Message: <textarea name='msg' cols='50' rows='5' maxlength='500'></textarea></p></fieldset>",
